...
public class TransactionController {
    ...
    // Mapeamento literal: o Spring resolve "/transactions/summary" antes do
    // padrão "/transactions/{category}", então não há conflito de rotas.
    @GetMapping("/summary")
    public SpendingSummaryResponse readSummary() {
        return SpendingSummaryResponse.from(summarizeTransactionsUseCase.execute());
    }
